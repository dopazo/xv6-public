...
_mainTarea:     formato del fichero elf32-i386
...
int main(void){
  ...
  11:	e8 fc 02 00 00       	call   312 <getPhysicalAddress>
  16:	83 ec 04             	sub    $0x4,%esp
  19:	50                   	push   %eax
  1a:	68 e0 06 00 00       	push   $0x6e0
  1f:	6a 01                	push   $0x1
...
00000312 <getPhysicalAddress>:
SYSCALL(getPhysicalAddress)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 35f:	f7 f6                	div    %esi
 361:	0f b6 92 0c 07 00 00 	movzbl 0x70c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4d8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 4db:	b8 04 07 00 00       	mov    $0x704,%eax
...
free(void *ap)
{
 ...
 561:	a1 a4 09 00 00       	mov    0x9a4,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5b7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5b9:	a3 a4 09 00 00       	mov    %eax,0x9a4
}
 5be:	5b                   	pop    %ebx
 5bf:	5e                   	pop    %esi
 5c0:	5f                   	pop    %edi
 ...
 5da:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 5dd:	a3 a4 09 00 00       	mov    %eax,0x9a4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 5f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 5fc:	8b 15 a4 09 00 00    	mov    0x9a4,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 69c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 69f:	89 15 a4 09 00 00    	mov    %edx,0x9a4
      return (void*)(p + 1);
 ...
 6b4:	eb e9                	jmp    69f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6b6:	c7 05 a4 09 00 00 a8 	movl   $0x9a8,0x9a4
 6bd:	09 00 00 
 6c0:	c7 05 a8 09 00 00 a8 	movl   $0x9a8,0x9a8
 6c7:	09 00 00 
    base.s.size = 0;
 6ca:	b8 a8 09 00 00       	mov    $0x9a8,%eax
 6cf:	c7 05 ac 09 00 00 00 	movl   $0x0,0x9ac
 6d6:	00 00 00 
